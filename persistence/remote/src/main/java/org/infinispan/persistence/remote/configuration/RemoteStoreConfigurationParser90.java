...
public class RemoteStoreConfigurationParser90 implements ConfigurationParser {

   private static final Log log = LogFactory.getLog(RemoteStoreConfigurationParser90.class, Log.class);

   public RemoteStoreConfigurationParser90() {
   }
   ...
   private void parseTransportExecutor(final XMLExtendedStreamReader reader,
      ...
      builder.withExecutorProperties(Parser90.parseProperties(reader));
   }
