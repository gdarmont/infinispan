...
public class Configuration {
   ...
   Configuration(ExecutorFactoryConfiguration executorFactory, Class<? extends FailoverRequestBalancingStrategy> balancingStrategyClass, FailoverRequestBalancingStrategy balancingStrategy, ClassLoader classLoader,
   ...
   public String toString() {
      return "Configuration [executorFactory=" + executorFactory + ", balancingStrategyClass=" + balancingStrategyClass + ", balancingStrategy=" + balancingStrategy + ",classLoader=" + classLoader + ", connectionPool="
